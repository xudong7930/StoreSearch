...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var detailViewController: DetailViewControler {
        return detailNavigationViewController.topViewController as! DetailViewControler
    }
    ...
    func customizeAppearance() {
        let barTintColor = UIColor(red: 20/255, green: 160/255, blue: 160/255, alpha: 1.0)
        
        UISearchBar.appearance().barTintColor = barTintColor
        
        window!.tintColor = UIColor(red: 10/255, green: 80/255, blue: 80/255, alpha: 1.0)
    }
